...
export const PIPELINE_STAGES: { value: PipelineStage; label: string; color: string; bg: string }[] = [
  { value: "novo", label: "Novo", color: "text-muted-foreground", bg: "bg-muted" },
  { value: "contato", label: "Contato", color: "text-info", bg: "bg-info/10" },
  { value: "qualificado", label: "Qualificado", color: "text-warning", bg: "bg-warning/10" },
  { value: "proposta", label: "Proposta", color: "text-primary", bg: "bg-primary/10" },
  { value: "negociacao", label: "Negociação", color: "text-accent-foreground", bg: "bg-accent" },
  { value: "ganho", label: "Ganho", color: "text-success", bg: "bg-success/10" },
  { value: "perdido", label: "Perdido", color: "text-destructive", bg: "bg-destructive/10" },
];
