...
const TaskKanbanView = ({ tasks, onTaskClick }: TaskKanbanViewProps) => {
          ...
          <div key={status} className="flex flex-col">
            <div className="flex items-center justify-between mb-3 px-1">
              <div className="flex items-center gap-2">
                <div className={`w-2 h-2 rounded-full ${sc.bg.replace("/.1", "")}`} style={{
                ...
                {columnTasks.map((task) => {
                  ...
                  return (
                    <div
                      ...
                      className="glass-card rounded-lg p-3 cursor-pointer hover:shadow-md transition-all hover:-translate-y-0.5 group"
                    >
